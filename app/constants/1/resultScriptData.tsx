...
const TEAM_1_RESULT_SCRIPT: Script[] = [
    {
        ...
        answer: "Patient : Great! I took the medication 3 times a day, and took it additionally at bedtime when my cough got worse.\nIt relieved my cough fast.\n"+
        "I drank enough water and tried to sit more at work, and now my condition has become much better.\n"+
        "This is all thanks to you."
    },
    {
        question: "Me (pharmacist) : I am glad to hear that.",
        answer: "Patient : There is one thing I wanted to ask you.\nI accidentally kept the drugs in the refrigerator for a while.\nIs it okay to still take them?"
    },
    {
