const TEAM_2_PROUDCT = [
    {
      src: '/Coldaewon-Cold-Q-Syrup.png',
      alt: 'product-A',
      name: 'Coldaewon Cold-Q Syrup',
      ingredient: 
      'Acetaminophen 325mg (antipyretic)\n'+
      'Chlorpheniramine maleate 2.5mg (1st gen antihistamine)\n'+
      'Dextromethorphan bromide hydrochloride 16mg (Antitussive)\n'+
      'DL-methylephedrine hydrochloride 21mg (Antitussive, Decongestant)\n'+
      'Guaifenesin 83mg (expectorant)\n'+
      'Caffeine 25mg (CNS stimulant)',
