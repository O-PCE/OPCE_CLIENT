    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 gap-20 relative">
      ...
      {flag2 ? (
        <div className="flex items-center justify-center rounded-md w-3/5 h-14 bg-white opacity-90]">
          <span className="text-gray-600 text-lg">
            Me (pharmacist): Hi, how are you? How can I help you?
          </span>
        </div>
      ) : null}
      {flag3 ? (
      ...
      {flag4 ? (
        <div className="flex flex-col items-center justify-center rounded-md w-full gap-8">
          ...
          >
            <span className="text-gray-600 text-lg">
              My daughter, and she&apos;s 4 uears old. She has a bad cough and sore throat.
            </span>
          </button>
          <button
            onClick={onClick12}
          ...
          >
            <span className="text-gray-600 text-lg">
              My father, and he&apos;s 68 years old with a history of high blood pressure and diabetes. He has severe nasal congestion and headache.
            </span>
          </button>
          <button
            onClick={onClick21}
          ...
          >
            <span className="text-gray-600 text-lg">
            My uncle, and he&apos;s 57 years old. He&apos;s been experiencing body aches and fever. He has
          ...
          >
            <span className="text-gray-600 text-lg">
              My mom, and she&apos;s 54 years old. She is currently complaining of a persistent, severe cough and headache. She is now taking ibuprofen to relieve cold-induced pain.
            </span>
          </button>
          <button
            onClick={onClick43}
          ...
          >
            <span className="text-gray-600 text-lg">
              My wife who&apos;s 30 years old and is in the last 3 months of pregnancy. She exercised vigorously in cold weather and caught a cold. She has a fever along with muscle pain and sprain.
            </span>
          </button>
        </div>
      ) : null}
